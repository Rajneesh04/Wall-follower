...
//
float distance1, distance2, currentDistance, integral, derivative, outputD, outputA, angle, previousAngle=0.0;
...
void follow_wall(){
  distance1 = sensor_output(trigPin1, echoPin1);
  distance2 = sensor_output(trigPin2, echoPin2);
  float angle = distance2-distance1;//if +ve trun left else turn right
